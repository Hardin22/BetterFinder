...
struct AppShortcut: Codable, Equatable, Hashable {
    ...
    static let focusTerminal   = AppShortcut(keyCode: 17,  modifiers: mod(.command, .shift))  // ⌘⇧T
    static let terminalFontUp     = AppShortcut(keyCode: 24,  modifiers: mod(.command, .shift))  // ⌘⇧+ (=)
